...
public class ContattoController {
	...
	*/
	...
	@PostMapping(path="/registra/{rub_id}", consumes = "application/json")
	...
	@DeleteMapping(path="/cancella/{rub_id}/{con_id}")
	...
	@GetMapping(path="/visualizza/{rub_id}/{con_id}", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@PutMapping(path = "/modifica/{rub_id}/{con_id}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	*/
	...
	@GetMapping(path="/visualizza/{rub_id}/tutti_contatti", produces = MediaType.APPLICATION_JSON_VALUE)
	public List<ContattoTelefonicoDTO> getAllContatti(@PathVariable int rub_id) {
		return service.getAllContatti(rub_id);
	}
	
	@GetMapping(path="/visualizza/{rub_id}/numero_contatti", produces = MediaType.APPLICATION_JSON_VALUE)
	public int getNumeroContatti(@PathVariable int rub_id) {
		return service.getNumeroContatti(rub_id);
	}
	
	@GetMapping(path="/visualizza/{rub_id}/contatto_by_numero", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@GetMapping(path="/visualizza/{rub_id}/gruppo_nome_cognome", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@GetMapping(path="/visualizza/{rub_id}/num_contatti_gruppo", produces = MediaType.APPLICATION_JSON_VALUE)
	public int getNumContattiInGruppo(@PathVariable int rub_id, 
			 						  @RequestParam String gruppo) {
		return service.getNumContattiInGruppo(rub_id, gruppo);
	}
	
	@GetMapping(path="/visualizza/{rub_id}/elimina_gruppo", produces = MediaType.APPLICATION_JSON_VALUE)
	public boolean destroyGroup(@PathVariable int rub_id, 
			  					@RequestParam String gruppo) {
		return service.destroyGroup(rub_id, gruppo);
	}
	
	@GetMapping(path="/visualizza/{rub_id}/preferiti", produces = MediaType.APPLICATION_JSON_VALUE)
