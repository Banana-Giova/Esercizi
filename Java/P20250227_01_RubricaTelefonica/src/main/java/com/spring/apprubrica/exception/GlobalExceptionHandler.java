...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErroreDTO> handleRubricaNotFoundException(RubricaNotFoundException ex) {
        logger.warning("Rubrica non trovata: " + ex.getMessage());
        ErroreDTO error_response = new ErroreDTO(
    ...
    public ResponseEntity<ErroreDTO> handleContattoNotFoundException(ContattoNotFoundException ex) {
        logger.warning("Contatto non trovato: " + ex.getMessage());
        ErroreDTO error_response = new ErroreDTO(
            HttpStatus.NOT_FOUND.value(),
            getCurrentTimestamp(),
            ex.getMessage(),
